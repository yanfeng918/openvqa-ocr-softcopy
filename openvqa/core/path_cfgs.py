...
class PATH:
    ...
    def init_path(self):
        ...
        self.DATA_ROOT = '/media/yanfeng/9801/MCAN/coco_extract/'


        self.DATA_PATH = {
            'vqa': self.DATA_ROOT,
            'vqa_raw': '/media/yanfeng/9801/MCAN',
            'gqa': '/media/yanfeng/9801/GQA/',
        ...
        self.FEATS_PATH = {
            ...
            'gqa': {
                'default-frcn': self.DATA_PATH['gqa'] + '/feats',
                'default-grid': self.DATA_PATH['gqa'] + '/feats',
            },
            'clevr': {
