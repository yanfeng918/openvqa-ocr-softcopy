...
class BaseDataSet(Data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        frcn_feat_iter, grid_feat_iter, bbox_feat_iter, ocr_glove_ix_iter, \
                ocr_fast_text, ocr_phoc_frn, ocr_bbox_iter, keep_1 = self.load_img_feats(idx, iid)
        ...
        return \
            ...
            torch.from_numpy(ocr_glove_ix_iter),\
            ocr_fast_text,\
            ocr_phoc_frn,\
            torch.from_numpy(ocr_bbox_iter),\
            torch.from_numpy(keep_1),\
            ans_iter
